...
@user_two = User.create(first_name: "Adaobi", last_name: "Okoye", email: "ada@ada.com", photo: "https://avatars.dicebear.com/api/micah/ada-okoye.svg", password: "password", password_confirmation: "password", confirmed_at: DateTime.now)
